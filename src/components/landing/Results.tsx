  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl">
        ...
        <ul className="mb-12 grid list-none gap-3 sm:grid-cols-2 lg:grid-cols-3 [&>*:last-child:nth-child(3n+1)]:lg:col-start-2">
          {skillKeys.map((key, i) => (
            <FadeIn key={key} as="li" delay={Math.floor(i / 3) * 0.08 + (i % 3) * 0.04}
              className="flex items-center gap-3 rounded-xl bg-surface-raised px-4 py-3.5 ring-1 ring-line transition-colors hover:ring-accent-300 dark:hover:ring-accent-800/60"
            >
        ...
        {/* Motivational quote */}
        <FadeIn>
          <blockquote className="gradient-border mx-auto mb-10 max-w-2xl rounded-2xl">
