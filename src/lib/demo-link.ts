...
// ▶️ Временный feature-флаг доступности игры. Игра оттестирована и готова → переход
// включён. Позже флаг можно убрать совсем (тогда кнопка всегда будет ссылкой).
// Тип boolean — чтобы при false не появлялась «недостижимая ветка» у вызывающих.
const DEMO_ENABLED: boolean = true;
